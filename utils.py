...
def find_size_conv_layers_and_fc_layers(size, kernel_size, padding, stride, dims_latent, sfc_nums, input_channel, increase_multi, num_final_channels, FC, nfclayers):
    '''
    ...
    if nfclayers <1 and num_final_channels * sfc_nums > intval:
